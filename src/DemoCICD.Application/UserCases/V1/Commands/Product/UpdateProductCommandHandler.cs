...
public sealed class UpdateProductCommandHandler : ICommandHandler<UpdatedProduct>
{
    ...
    public async Task<Result> Handle(UpdatedProduct request, CancellationToken cancellationToken)
    {
